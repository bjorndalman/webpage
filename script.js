...
const defaultData = { // ENGELSKA (BAS)
  ...
  education: [
    ...
    },
    {
      ...
      "years": "",
      "description": "<img src=\"jagar_badge.jpg\" alt=\"JÄGARE badge\" style=\"height: 18px; vertical-align: middle; margin-right: 5px;\"> Completed advanced basic military training as a Ranger (Jägare)."
}
  ],
  experience: [
    {
